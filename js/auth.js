...
async function handleLogin(e) {
    ...
    const userNameInput = document.getElementById('loginUsername') || document.querySelector('#loginForm input[type="text"]');
    const passwordInput = document.getElementById('loginPassword') || document.querySelector('#loginForm input[type="password"]');
    const roleSelect = document.getElementById('userRole');

    const user_name = userNameInput ? userNameInput.value.trim() : '';
